              ...
              <nav class="space-y-1">
                ...
                <template v-if="auth.user?.perfil === 'admin'">
                  ...
                  >
                    ...
                    <span class="text-sm font-semibold text-slate-700 group-hover:text-primary-700">Dashboard Admin</span>
                  </button>
                  <button
                    class="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-primary-50 hover:text-primary-700 rounded-xl transition-all group"
                  ...
                  >
                    ...
                    <span class="text-sm font-semibold text-slate-700 group-hover:text-primary-700">Gestão de Cardápios</span>
                  </button>
                  <button
                    class="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-primary-50 hover:text-primary-700 rounded-xl transition-all group"
                    @click="router.push('/admin/presencas'); menuPanel?.hide()"
                  >
                    <i class="pi pi-check-circle text-slate-500 group-hover:text-primary-600 transition-colors"></i>
                    <span class="text-sm font-semibold text-slate-700 group-hover:text-primary-700">Controle de Presenças</span>
                  </button>
                  <button
                    class="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-primary-50 hover:text-primary-700 rounded-xl transition-all group"
                    @click="router.push('/admin/bolsistas'); menuPanel?.hide()"
                  >
                    <i class="pi pi-users text-slate-500 group-hover:text-primary-600 transition-colors"></i>
                    <span class="text-sm font-semibold text-slate-700 group-hover:text-primary-700">Gestão de Bolsistas</span>
                  </button>
                  <button
                    class="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-primary-50 hover:text-primary-700 rounded-xl transition-all group"
                ...
                <button
                  class="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-red-50 hover:text-red-700 rounded-xl transition-all group"
                  @click="handleLogout"
                >
                  <i class="pi pi-sign-out text-red-500 group-hover:text-red-600 transition-colors"></i>
                  <span class="text-sm font-semibold text-red-700">Sair</span>
                </button>
              </nav>
            </div>
          </OverlayPanel>
